...
namespace IvansApp.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        {
            IvansApp.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@IvansApp.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@IvansApp.com", "ASP.NET", "Code OnTime", true, out status);
