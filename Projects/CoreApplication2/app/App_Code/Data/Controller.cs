...
namespace IvansCompany.Data
{
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(String.Format("IvansCompany.controllers.{0}.xml", controller), String.Format("IvansCompany.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(IvansCompany.Data.Controller);
            Stream res = ControllerConfigurationUtility.GetResourceStream(String.Format("IvansCompany.Reports.{0}", name), String.Format("IvansCompany.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                ControllerConfiguration config = IvansCompany.Data.Controller.CreateConfigurationInstance(t, controller);
