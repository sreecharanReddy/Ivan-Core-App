...
namespace IvansCompany.Data
{
    ...
    public class BusinessRulesBase : ActionHandlerBase, IvansCompany.Data.IRowHandler, IvansCompany.Data.IDataFilter, IvansCompany.Data.IDataFilter2
    {
            ...
            if (propertyName.StartsWith("Url_"))
            {
            	...
            	if (propertyName.StartsWith("Session_"))
                {
                	...
                	if (propertyName.StartsWith("Profile_"))
                    {
                        ...
                        {
                            propertyName = propertyName.Substring(8);
                            JObject profile = ((JObject)(HttpContext.Current.Items["profile"]));
                            if (profile == null)
                            {
                            ...
                            if (profile != null)
                            	foreach (KeyValuePair<string, JToken> kvp in profile)
